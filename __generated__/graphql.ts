...
export type Get_Index_Data_QueryQuery = { __typename?: 'Query', getAllIndexData: Array<{ __typename?: 'CandleSet', symbol: string, candles: Array<{ __typename?: 'Candle', open: string, close: string, high: string, low: string, volume?: string | null, time: string }> }> };
