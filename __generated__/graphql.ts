...
export type Get_Index_Data_QueryQuery = { __typename?: 'Query', getAllIndexData: Array<{ __typename?: 'PercentageChanges', symbol: string, previousClose: number, latestValue: number, values: Array<{ __typename?: 'PercentageChangeValue', percentageChange: number, time: string }> }> };
